...
//追加
		if(init){
			// 複数のマーカーを設定
			var markers = [
				{ lat: 35.170697, lng: 136.881626, comment: "指定地点２" },
				{ lat: 35.183685, lng: 136.933103, comment: "指定地点１" },
				{ lat: 35.179517, lng: 136.881296, comment: "指定地点３" },
				{ lat: 35.178511, lng: 136.895176, comment: "指定地点４" }
			];
